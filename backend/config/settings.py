...
INSTALLED_APPS = [
    ...
    # 🔌 Packages tiers indispensables pour l'API, Swagger et la sécurité Web
    'corsheaders',
    'rest_framework',
    'rest_framework_simplejwt',  # Système de tokens JWT
    'drf_spectacular',           # Documentation Swagger

    # 🏢 Les applications métiers créées pour le projet
    'materiels',
    'utilisateurs',
    'emprunts',
    'maintenance',
...
MIDDLEWARE = [
    ...
    'corsheaders.middleware.CorsMiddleware',  # 🌐 Intercepte les requêtes CORS en priorité absolue
...
LANGUAGE_CODE = 'fr-fr'  # Configuration en français pour le projet de stage
...
REST_FRAMEWORK = {
    ...
    # Déclare la méthode d'authentification par défaut (SimpleJWT)
...
# Autorisation des requêtes cross-origin (React/Flutter)
